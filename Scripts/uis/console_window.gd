...
func add_message(type, level, text):
	if type == "User":
		console_log.append_text("\n[color=" + Types[type].color + "][" + username + "][/color] " +  text)
		print("[" + level + "][" + username + "] " + text)
	elif not Types[type].visible == "false":
		console_log.append_text("\n[color=" + Types[type].color + "][" + type + "][/color] [color=" + Levels[level].color + "]" + text + "[/color]")
...
func use_command(text):
	...
	if text == "/help" or text == "/h":
		...
		if text == "/clear " or text == "/clear help" or  text == "/clear h":
			...
			console_log.text = "[color=" + Types.Help.color + "][Help][/color] [color=" + Levels.Global.color + "]" + 'Type: "/help" For Commands.' + "[/color]"
